...
export default function NovaINSSPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Tabela criada',
        description: 'A tabela de INSS foi criada com sucesso.',
      })
      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold tracking-tight">Nova Tabela de INSS</h1>
              <p className="text-muted-foreground">
                Configure as faixas e alíquotas de INSS para empregado e empregador
              </p>
            </div>
          </div>
